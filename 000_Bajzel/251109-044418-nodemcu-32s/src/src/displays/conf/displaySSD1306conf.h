...
const ScrollConfig metaConf       PROGMEM = {{ TFT_FRAMEWDT, 0, 2, WA_LEFT }, 140, false, MAX_WIDTH, 5000, 3, 15 };
const ScrollConfig title1Conf     PROGMEM = {{ 0, 17, 1, WA_LEFT }, 140, false, DSP_WIDTH-6*4, 5000, 2, 35 };
const ScrollConfig title2Conf     PROGMEM = {{ 0, 26, 1, WA_LEFT }, 140, false, DSP_WIDTH, 5000, 2, 35 };
const ScrollConfig playlistConf   PROGMEM = {{ TFT_FRAMEWDT, 26, 1, WA_LEFT }, 140, false, MAX_WIDTH, 500, 2, 25 };
...
const ScrollConfig weatherConf    PROGMEM = {{ 0, 64-11, 1, WA_LEFT }, 140, false, DSP_WIDTH-6*4, 0, 2, 25 }; // ПОГОДА!!
