...
void DspCore::_clockDate(){
  ...
  setCursor(_dateleft, clockTop+25);
  setTextSize(2);
...
void DspCore::_clockTime(){
  ...
  if(!config.isScreensaver) drawFastHLine(width()-clockRightSpace-CHARWIDTH*4*2-18, clockTop-clockTimeHeight+27, 59, config.theme.div);              /*divider hor*/
