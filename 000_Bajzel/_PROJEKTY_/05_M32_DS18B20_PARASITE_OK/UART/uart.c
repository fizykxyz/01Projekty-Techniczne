...
void UART_SEND(char data) { //wysy³anie jednego bajta danych przez uart
...
void UART_SENDSTR_P(const char *s) { //przesy³anie stringów przez uart
...
{
	char buffer[15];
	UART_SENDSTR( ltoa( val, buffer, 10 ) );
} /* uart_puti */
