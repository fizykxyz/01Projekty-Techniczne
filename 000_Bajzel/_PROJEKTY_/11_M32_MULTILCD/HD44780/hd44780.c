...
TSCREEN HD44780_EN = {16,2,w2b(PA,7)};

void HD44780_NR(uint8_t NR,TSCREEN *EN ){
HD44780_EN.KOL=EN[NR].KOL;
HD44780_EN.LIN=EN[NR].LIN;
HD44780_EN.EN=EN[NR].EN;
...
{
#if PINARRAY
	if (ONOFF) HIGH_A(HD44780_EN.EN); else LOW_A(HD44780_EN.EN);
#else
	if (ONOFF) HIGH(HD44780_E); else HIGH(HD44780_E);
#endif
}
