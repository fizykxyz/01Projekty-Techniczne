...
HD44780_CLR();
//PORTB=0xAA;//
HD44780_TEXT(strupr(TOSTRING(__AVR_DEVICE_NAME__)));

//HD44780_TEXT(strupr(TOSTRING(MCU)));
_delay_ms(3000);
HD44780_TEXT(strDate);
_delay_ms(4000);
