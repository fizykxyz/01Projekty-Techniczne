...
#define DISP_CS1_SET IOSET0    // linia nChipSelect1
#define DISP_CS1_CLR IOCLR0
#define DISP_CS1_DDR IODIR0
#define DISP_CS1_NO 19
#define DISP_CS2_SET IOSET0    // linia nChipSelect2
#define DISP_CS2_CLR IOCLR0
#define DISP_CS2_DDR IODIR0
#define DISP_CS2_NO 20
#define DISP_RES_SET IOSET0    // linia nReset
#define DISP_RES_CLR IOCLR0
#define DISP_RES_DDR IODIR0
#define DISP_RES_NO 21
