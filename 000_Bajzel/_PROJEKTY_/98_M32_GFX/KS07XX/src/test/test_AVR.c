...
const char PROGMEM intro[] = "Test KS07XX";
    ...
    switch(test_no) {
      ...
      case 21:
        if (def_ini("Contrast") == 1)
          ...
          Disp_clr();
          Disp_box(32,16,97,47,ON,YES);
          uint8_t contrast = 0;
          Disp_set_contrast(contrast, OFF);
          while (!get_key2()) {
            char num[3];
