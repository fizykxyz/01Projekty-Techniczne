 ...
 */
#define DISP_MOSI_GP   __GPIO8           // linia Data
 ...
 */
#define DISP_CS1_GP   __GPIO8           // linia nChipSelect
#define DISP_CS1_DR   GPIO8->DR[1<<(DISP_CS1_NO+2)]
#define DISP_CS1_DDR  GPIO8->DDR
#define DISP_CS1_TYPE SCU->GPIOTYPE[8]
#define DISP_CS1_OUT  SCU->GPIOOUT[8]
#define DISP_CS1_IN   SCU->GPIOIN[8]
#define DISP_CS1_NO 1
#define DISP_CLK_GP   __GPIO8           // linia Clock
