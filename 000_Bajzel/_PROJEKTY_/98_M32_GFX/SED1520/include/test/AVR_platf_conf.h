 ...
 */
#define DISP_RS_PORT PORTB    // linia Register Select (A0)
#define DISP_RS_DDR DDRB
#define DISP_RS_NO 0

#define DISP_RW_PORT PORTB    // linia Read/nWrite (interfejs 6800)
#define DISP_RW_DDR DDRB
#define DISP_RW_NO 1
#define DISP_E1_PORT PORTD    // linia Enable1 (interfejs 6800)
#define DISP_E1_DDR DDRD
#define DISP_E1_NO 0 
#define DISP_E2_PORT PORTD    // linia Enable2 (interfejs 6800)
#define DISP_E2_DDR DDRD
#define DISP_E2_NO 1
/*
#define DISP_WR_PORT PORTB    // linia nWrite (interfejs 8080)
#define DISP_WR_DDR DDRB
#define DISP_WR_NO 1
#define DISP_RD_PORT PORTD    // linia nRead (interfejs 8080)
#define DISP_RD_DDR DDRD
#define DISP_RD_NO 0
#define DISP_CS1_PORT PORTD   // linia Chip Select1 (interfejs 8080)
#define DISP_CS1_DDR DDRD
#define DISP_CS1_NO 2
#define DISP_CS2_PORT PORTD   // linia Chip Select2 (interfejs 8080)
#define DISP_CS2_DDR DDRD
#define DISP_CS2_NO 3
*/
