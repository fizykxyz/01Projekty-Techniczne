...
const char PROGMEM intro[] = "Test SED1520";
const char PROGMEM end[] = " Test end";
const char PROGMEM test[] = "Test";
const PROGMEM uint8_t charset[] = CHARSET;
  ...
  while(1) {
    switch(test_no) {
      ...
      case 13:
        ...
        Disp_set_update(DEFERRED);
        Disp_set_pxy(10,10);
        Disp_lineto(20,20, ON);
        Disp_lineto(30,10, ON);
        Disp_lineto(40,20, ON);
        Disp_lineto(50,10, ON);
        Disp_lineto(60,20, ON);
        Disp_lineto(70,10, ON);
        Disp_lineto(70,20, ON);
        Disp_lineto(60,10, ON);
        Disp_lineto(50,20, ON);
        Disp_lineto(40,10, ON);
        Disp_lineto(30,20, ON);
        Disp_lineto(20,10, ON);
        Disp_lineto(10,20, ON);
        ...
        Disp_set_pxy(10,10);
        Disp_get_picture(pictc,61,11);
        
        Disp_set_update(DEFERRED);
        Disp_clr();
        Disp_set_pxy(0,0);
        Disp_put_picture(pictc,61,11);
        Disp_set_pxy(61,0);
        Disp_put_picture(pictc,61,11);
        Disp_set_pxy(0,11);
        Disp_put_picture(pictc,61,11);
      ...
      case 17:
        ...
        Disp_lineto(5,31,ON);
        Disp_lineto(10,0,ON);
        Disp_lineto(20,31,ON);
        Disp_lineto(30,0,ON);
        Disp_lineto(50,31,ON);
        Disp_lineto(70,0,ON);
        Disp_lineto(110,31,ON);
        Disp_lineto(121,0,ON);
        wait_key2();
        
        Disp_clr();
        Disp_set_pxy(0,0);
        Disp_lineto(121,5,ON);
        Disp_lineto(0,10,ON);
        Disp_lineto(121,20,ON);
        Disp_lineto(0,30,ON);
        Disp_lineto(121,31,ON);
        wait_key2();
        ...
        Disp_clr();
        Disp_set_pxy(63,15);
        Disp_lineto(63,31,ON);
        Disp_set_pxy(63,15);
        Disp_lineto(63,0,ON);
        Disp_set_pxy(63,15);
        Disp_lineto(121,15,ON);
        Disp_set_pxy(63,15);
        Disp_lineto(0,15,ON);
        Disp_set_pxy(63,15);
        Disp_lineto(0,0,ON);
      ...
      case 19:
        ...
        Disp_clr();
        Disp_box(1,1,120,30,ON,NO);
        Disp_box(118,28,3,3,ON,NO);
        Disp_box(5,5,116,26,ON,NO);
        Disp_box(114,24,7,7,ON,NO);
        Disp_box(9,9,112,22,ON,NO);
        Disp_box(110,20,11,11,ON,NO);
        wait_key2();
        
        Disp_clr();
        Disp_box(1,1,120,30,ON,YES);
        Disp_box(118,28,3,3,OFF,YES);
        Disp_box(5,5,116,26,ON,YES);
        Disp_box(114,24,7,7,OFF,YES);
        Disp_box(9,9,112,22,ON,YES);
        Disp_box(110,20,11,11,OFF,YES);
        wait_key2();
