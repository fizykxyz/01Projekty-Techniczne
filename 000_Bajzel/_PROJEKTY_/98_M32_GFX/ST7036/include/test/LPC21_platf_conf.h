...
#define DISP_E1_SET IOSET0     // linia Enable
 ...
 */
#define DISP_MOSI_SET IOSET1   // linia SI
#define DISP_MOSI_CLR IOCLR1
#define DISP_MOSI_PIN IOPIN1
#define DISP_MOSI_DDR IODIR1
#define DISP_MOSI_NO 23
#define DISP_CLK_SET IOSET1    // linia SCL
#define DISP_CLK_CLR IOCLR1
#define DISP_CLK_PIN IOPIN1
#define DISP_CLK_DDR IODIR1
#define DISP_CLK_NO 22
#define DISP_CS1_SET IOSET0    // linia CSB
#define DISP_CS1_CLR IOCLR0
#define DISP_CS1_DDR IODIR0
#define DISP_CS1_NO 22
