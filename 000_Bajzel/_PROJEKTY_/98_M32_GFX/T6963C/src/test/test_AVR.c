...
const char PROGMEM intro[] = "Test T6963C";
const char PROGMEM end[] = " Test end";
const char PROGMEM test[] = "Test";
...
const uint8_t PROGMEM cpict2[] = { /* width 16, length 20*/
  0x00, 0x00,
  0xAE, 0x7A,
  0x5E, 0x75,
  0xAE, 0x7A,
  ...
  while(1) {
    switch(test_no) {
      ...
      case 7:
        ...
        for (int i=0; i<15; i++) {
          Disp_scroll_txt_window(DOWN);
          wait_ms(150);
        }
        
        for (int i=0; i<15; i++) {
          Disp_scroll_txt_window(UP);
          wait_ms(150);
        }
      ...
      case 10:
        ...
        for (uint8_t i=0; i<8; i++) {
          for (uint8_t j=0; j<8; j++) {
            Disp_box(0,0,239,127,ON,YES);
            Disp_set_pxy(58+i,j);
            Disp_put_picture(pict1, 50, 7);
            Disp_set_pxy(58+i,j);
            Disp_get_picture(pictc, 50, 7);
            Disp_set_pxy(58+i,j+10);
            Disp_put_picture(pictc, 50, 7);
            wait_ms(200);
            if (get_key2())
             break;      
      ...
      case 11:
        ...
        Disp_set_ctempl_const(pl_charset, PL_CHARSET_LENGTH, 128);
      ...
      case 17:
        ...
        Disp_lineto(5,63,ON);
        Disp_lineto(10,0,ON);
        Disp_lineto(20,63,ON);
        Disp_lineto(30,0,ON);
        Disp_lineto(50,63,ON);
        Disp_lineto(70,0,ON);
        Disp_lineto(110,63,ON);
        Disp_lineto(127,0,ON);
        wait_key2();
        
        Disp_clr();
        Disp_set_pxy(0,0);
        Disp_lineto(127,5,ON);
        Disp_lineto(0,10,ON);
        Disp_lineto(127,20,ON);
        Disp_lineto(0,30,ON);
        Disp_lineto(127,50,ON);
        Disp_lineto(0,63,ON);
        wait_key2();
        
        Disp_clr();
        Disp_set_pxy(0,0);
        Disp_lineto(127,63,ON);
        Disp_set_pxy(127,0);
        Disp_lineto(0,63,ON);
        wait_key2();
        ...
        Disp_clr();
        Disp_set_pxy(63,31);
        Disp_lineto(63,63,ON);
        Disp_set_pxy(63,31);
        Disp_lineto(63,0,ON);
        Disp_set_pxy(63,31);
        Disp_lineto(127,31,ON);
        Disp_set_pxy(63,31);
        Disp_lineto(0,31,ON);
        Disp_set_pxy(63,31);
        Disp_lineto(0,0,ON);
      ...
      case 19:
        ...
        Disp_clr();
        Disp_box(1,1,126,62,ON,NO);
        Disp_box(124,60,3,3,ON,NO);
        Disp_box(5,5,122,58,ON,NO);
        Disp_box(120,56,7,7,ON,NO);
        Disp_box(9,9,118,54,ON,NO);
        Disp_box(116,52,11,11,ON,NO);
        wait_key2();
        
        Disp_clr();
        Disp_box(1,1,126,62,ON,YES);
        Disp_box(124,60,3,3,OFF,YES);
        Disp_box(5,5,122,58,ON,YES);
        Disp_box(120,56,7,7,OFF,YES);
        Disp_box(9,9,118,54,ON,YES);
        Disp_box(116,52,11,11,OFF,YES);
        wait_key2();
      ...
      case 20:
        ...
        Disp_set_cxy(1,0);
        Disp_puts("TL");
        Disp_set_cxy(DISP_C_COLS_NUM-1,DISP_C_ROWS_NUM-1);
        Disp_puts("BR");
      ...
      case 22:
        ...
        Disp_set_cxy(0,1);
        Disp_set_ctempl_const(pl_charset, PL_CHARSET_LENGTH, 128);
        Disp_get_ctempl(str64, 64, 128);
        Disp_set_ctempl(str64, 64, 128);
        Disp_set_cxy(0,1);
        Disp_putc(PL_A);
        Disp_putc(PL_C);
        Disp_putc(PL_E);
      ...
      /*********************************************/
      case 23:
        if (def_ini("CG modes") == 1)
          break;
        
        Disp_clr();
        for (uint8_t i = 0; i<10; i++)
          Disp_line(0,i*2,64,i*2,ON);
        ...
        Disp_set_cxy(0,0);
        Disp_puts("AND");
        Disp_set_cg_mode(ROMRAM, AND);
        wait_key2();
        
        Disp_set_cxy(0,0);
        Disp_puts("XOR");
        Disp_set_cg_mode(ROMRAM, XOR);
        wait_key2();
        
        Disp_set_cxy(0,0);
        Disp_puts("OR ");
        Disp_set_cg_mode(ROMRAM, OR);
        wait_key2();
