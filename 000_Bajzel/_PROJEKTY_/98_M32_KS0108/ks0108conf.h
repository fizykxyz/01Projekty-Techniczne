...
// GLCD_PORT_INTERFACE specifics
	...
	// make sure these parameters are not already defined elsewhere
		...
		#define GLCD_CTRL_RS	PA1		// pin for LCD Register Select
		#define GLCD_CTRL_RW	PA0		// pin for LCD Read/Write
		#define GLCD_CTRL_E		PA2		// pin for LCD Enable
		#define GLCD_CTRL_CS0	PA3		// pin for LCD Controller 0 Chip Select
		#define GLCD_CTRL_CS1	PA4		// pin for LCD Controller 1 Chip Select(*)
		#define GLCD_CTRL_CS2	PA6		// pin for LCD Controller 2 Chip Select(*)
		#define GLCD_CTRL_CS3	PA7		// pin for LCD Controller 3 Chip Select(*)
		#define GLCD_CTRL_RESET	PA7		// pin for LCD Reset
